 ...
 */
final class Version20210602124939 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__article AS SELECT id, promotion_id, titre, description, multimedia, etat, quantite, frais_envoi, prix, age, date FROM article');
        ...
        $this->addSql('INSERT INTO article (id, promotion_id, titre, description, multimedia, etat, quantite, frais_envoi, prix, age, date) SELECT id, promotion_id, titre, description, multimedia, etat, quantite, frais_envoi, prix, age, date FROM __temp__article');
        ...
        $this->addSql('ALTER TABLE categorie ADD COLUMN couleur VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__article AS SELECT id, promotion_id, titre, description, multimedia, etat, quantite, frais_envoi, prix, age, date FROM article');
        $this->addSql('DROP TABLE article');
        $this->addSql('CREATE TABLE article (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, promotion_id INTEGER DEFAULT NULL, titre VARCHAR(255) NOT NULL, description CLOB DEFAULT NULL, multimedia VARCHAR(255) DEFAULT NULL, etat VARCHAR(255) NOT NULL, quantite INTEGER NOT NULL, frais_envoi INTEGER NOT NULL, prix INTEGER DEFAULT NULL, age VARCHAR(255) DEFAULT NULL, date DATETIME DEFAULT NULL)');
        $this->addSql('INSERT INTO article (id, promotion_id, titre, description, multimedia, etat, quantite, frais_envoi, prix, age, date) SELECT id, promotion_id, titre, description, multimedia, etat, quantite, frais_envoi, prix, age, date FROM __temp__article');
        $this->addSql('DROP TABLE __temp__article');
        $this->addSql('CREATE INDEX IDX_23A0E66139DF194 ON article (promotion_id)');
        $this->addSql('DROP INDEX IDX_934886107294869C');
        ...
        $this->addSql('CREATE INDEX IDX_4D3A44FA7294869C ON article_materiel (article_id)');
        $this->addSql('CREATE INDEX IDX_4D3A44FA16880AAF ON article_materiel (materiel_id)');
        $this->addSql('CREATE TEMPORARY TABLE __temp__categorie AS SELECT id, nom, description, etat FROM categorie');
        ...
        $this->addSql('INSERT INTO categorie (id, nom, description, etat) SELECT id, nom, description, etat FROM __temp__categorie');
