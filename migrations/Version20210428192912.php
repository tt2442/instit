 ...
 */
final class Version20210428192912 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__user AS SELECT id, email, roles, password, nom, prenom, sexe, adresse, ville, region, mobile, fixe, pays, code_postal FROM user');
        ...
        , password VARCHAR(255) NOT NULL COLLATE BINARY, nom VARCHAR(255) NOT NULL COLLATE BINARY, prenom VARCHAR(255) NOT NULL COLLATE BINARY, sexe VARCHAR(255) DEFAULT NULL COLLATE BINARY, ville VARCHAR(255) DEFAULT NULL COLLATE BINARY, region VARCHAR(255) DEFAULT NULL COLLATE BINARY, mobile VARCHAR(255) DEFAULT NULL COLLATE BINARY, fixe VARCHAR(255) DEFAULT NULL COLLATE BINARY, pays VARCHAR(255) DEFAULT NULL COLLATE BINARY, code_postal VARCHAR(255) DEFAULT NULL COLLATE BINARY, adresse CLOB DEFAULT NULL)');
        $this->addSql('INSERT INTO user (id, email, roles, password, nom, prenom, sexe, adresse, ville, region, mobile, fixe, pays, code_postal) SELECT id, email, roles, password, nom, prenom, sexe, adresse, ville, region, mobile, fixe, pays, code_postal FROM __temp__user');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE INDEX IDX_57B93FD69DA45D70 ON materiels_liens_internes (liens_internes_id)');
        $this->addSql('DROP INDEX UNIQ_8D93D649E7927C74');
        $this->addSql('CREATE TEMPORARY TABLE __temp__user AS SELECT id, email, roles, password, nom, prenom, sexe, adresse, code_postal, ville, region, mobile, fixe, pays FROM user');
        $this->addSql('DROP TABLE user');
        $this->addSql('CREATE TABLE user (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, email VARCHAR(180) NOT NULL, roles CLOB NOT NULL --(DC2Type:json)
        , password VARCHAR(255) NOT NULL, nom VARCHAR(255) NOT NULL, prenom VARCHAR(255) NOT NULL, sexe VARCHAR(255) DEFAULT NULL, code_postal VARCHAR(255) DEFAULT NULL, ville VARCHAR(255) DEFAULT NULL, region VARCHAR(255) DEFAULT NULL, mobile VARCHAR(255) DEFAULT NULL, fixe VARCHAR(255) DEFAULT NULL, pays VARCHAR(255) DEFAULT NULL, adresse VARCHAR(255) DEFAULT NULL COLLATE BINARY)');
        $this->addSql('INSERT INTO user (id, email, roles, password, nom, prenom, sexe, adresse, code_postal, ville, region, mobile, fixe, pays) SELECT id, email, roles, password, nom, prenom, sexe, adresse, code_postal, ville, region, mobile, fixe, pays FROM __temp__user');
        $this->addSql('DROP TABLE __temp__user');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_8D93D649E7927C74 ON user (email)');
        $this->addSql('DROP INDEX IDX_5F50D568A76ED395');
        $this->addSql('DROP INDEX IDX_5F50D5681EBAF6CC');
