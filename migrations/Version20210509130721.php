 ...
 */
final class Version20210509130721 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE fichier (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, image VARCHAR(255) DEFAULT NULL, tag VARCHAR(255) DEFAULT NULL, degrade BOOLEAN NOT NULL, enligne BOOLEAN NOT NULL)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE fichiers (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, image VARCHAR(255) DEFAULT NULL COLLATE BINARY, degrade BOOLEAN NOT NULL, enligne BOOLEAN NOT NULL, tag VARCHAR(255) DEFAULT NULL COLLATE BINARY)');
