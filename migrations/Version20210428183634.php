 ...
 */
final class Version20210428183634 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        , password VARCHAR(255) NOT NULL COLLATE BINARY, nom VARCHAR(255) NOT NULL COLLATE BINARY, prenom VARCHAR(255) NOT NULL COLLATE BINARY, sexe VARCHAR(255) DEFAULT NULL COLLATE BINARY, adresse VARCHAR(255) DEFAULT NULL COLLATE BINARY, ville VARCHAR(255) DEFAULT NULL COLLATE BINARY, region VARCHAR(255) DEFAULT NULL COLLATE BINARY, mobile VARCHAR(255) DEFAULT NULL COLLATE BINARY, fixe VARCHAR(255) DEFAULT NULL COLLATE BINARY, pays VARCHAR(255) DEFAULT NULL COLLATE BINARY, code_postal VARCHAR(255) DEFAULT NULL)');
    ...
    public function down(Schema $schema): void
    {
        ...
        , password VARCHAR(255) NOT NULL, nom VARCHAR(255) NOT NULL, prenom VARCHAR(255) NOT NULL, sexe VARCHAR(255) DEFAULT NULL, adresse VARCHAR(255) DEFAULT NULL, ville VARCHAR(255) DEFAULT NULL, region VARCHAR(255) DEFAULT NULL, mobile VARCHAR(255) DEFAULT NULL, fixe VARCHAR(255) DEFAULT NULL, pays VARCHAR(255) DEFAULT NULL, code_postal INTEGER DEFAULT NULL)');
        $this->addSql('INSERT INTO user (id, email, roles, password, nom, prenom, sexe, adresse, code_postal, ville, region, mobile, fixe, pays) SELECT id, email, roles, password, nom, prenom, sexe, adresse, code_postal, ville, region, mobile, fixe, pays FROM __temp__user');
        $this->addSql('DROP TABLE __temp__user');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_8D93D649E7927C74 ON user (email)');
        $this->addSql('DROP INDEX IDX_5F50D568A76ED395');
