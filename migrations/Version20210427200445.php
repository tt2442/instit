 ...
 */
final class Version20210427200445 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE articles (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, promotions_id INTEGER DEFAULT NULL, titre VARCHAR(255) NOT NULL COLLATE BINARY, multimedia VARCHAR(255) DEFAULT NULL COLLATE BINARY, etat VARCHAR(255) NOT NULL COLLATE BINARY, quantite INTEGER NOT NULL, frais_envoi INTEGER NOT NULL, prix INTEGER DEFAULT NULL, description CLOB DEFAULT NULL, CONSTRAINT FK_BFDD316810007789 FOREIGN KEY (promotions_id) REFERENCES promotions (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__categories AS SELECT id, nom, description, etat FROM categories');
        $this->addSql('DROP TABLE categories');
        $this->addSql('CREATE TABLE categories (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, nom VARCHAR(255) NOT NULL COLLATE BINARY, etat BOOLEAN NOT NULL, description CLOB DEFAULT NULL)');
        $this->addSql('INSERT INTO categories (id, nom, description, etat) SELECT id, nom, description, etat FROM __temp__categories');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__fichiers AS SELECT id, image, tag, degrade, enligne FROM fichiers');
        $this->addSql('DROP TABLE fichiers');
        $this->addSql('CREATE TABLE fichiers (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, image VARCHAR(255) DEFAULT NULL COLLATE BINARY, degrade BOOLEAN NOT NULL, enligne BOOLEAN NOT NULL, tag VARCHAR(255) DEFAULT NULL)');
        $this->addSql('INSERT INTO fichiers (id, image, tag, degrade, enligne) SELECT id, image, tag, degrade, enligne FROM __temp__fichiers');
        $this->addSql('DROP TABLE __temp__fichiers');
        $this->addSql('CREATE TEMPORARY TABLE __temp__liens_externes AS SELECT id, site, url, prix, observation FROM liens_externes');
        $this->addSql('DROP TABLE liens_externes');
        $this->addSql('CREATE TABLE liens_externes (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, site VARCHAR(255) DEFAULT NULL COLLATE BINARY, url VARCHAR(255) DEFAULT NULL COLLATE BINARY, prix INTEGER DEFAULT NULL, observation CLOB DEFAULT NULL)');
        $this->addSql('INSERT INTO liens_externes (id, site, url, prix, observation) SELECT id, site, url, prix, observation FROM __temp__liens_externes');
        $this->addSql('DROP TABLE __temp__liens_externes');
        $this->addSql('CREATE TEMPORARY TABLE __temp__liens_internes AS SELECT id, observation FROM liens_internes');
        $this->addSql('DROP TABLE liens_internes');
        $this->addSql('CREATE TABLE liens_internes (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, observation CLOB DEFAULT NULL)');
        $this->addSql('INSERT INTO liens_internes (id, observation) SELECT id, observation FROM __temp__liens_internes');
        $this->addSql('DROP TABLE __temp__liens_internes');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__promotions AS SELECT id, date_start, date_end, etat, nom, description, type, valeur FROM promotions');
        $this->addSql('DROP TABLE promotions');
        $this->addSql('CREATE TABLE promotions (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, date_start DATETIME NOT NULL, date_end DATETIME DEFAULT NULL, etat BOOLEAN NOT NULL, nom VARCHAR(255) NOT NULL COLLATE BINARY, type VARCHAR(255) NOT NULL COLLATE BINARY, valeur INTEGER NOT NULL, description CLOB DEFAULT NULL)');
        $this->addSql('INSERT INTO promotions (id, date_start, date_end, etat, nom, description, type, valeur) SELECT id, date_start, date_end, etat, nom, description, type, valeur FROM __temp__promotions');
        $this->addSql('DROP TABLE __temp__promotions');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__articles AS SELECT id, promotions_id, titre, description, multimedia, etat, quantite, frais_envoi, prix FROM articles');
        $this->addSql('DROP TABLE articles');
        $this->addSql('CREATE TABLE articles (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, promotions_id INTEGER DEFAULT NULL, titre VARCHAR(255) NOT NULL, multimedia VARCHAR(255) DEFAULT NULL, etat VARCHAR(255) NOT NULL, quantite INTEGER NOT NULL, frais_envoi INTEGER NOT NULL, prix INTEGER DEFAULT NULL, description VARCHAR(255) DEFAULT NULL COLLATE BINARY)');
        $this->addSql('INSERT INTO articles (id, promotions_id, titre, description, multimedia, etat, quantite, frais_envoi, prix) SELECT id, promotions_id, titre, description, multimedia, etat, quantite, frais_envoi, prix FROM __temp__articles');
        $this->addSql('DROP TABLE __temp__articles');
        $this->addSql('CREATE INDEX IDX_BFDD316810007789 ON articles (promotions_id)');
        $this->addSql('DROP INDEX IDX_DE004A0E1EBAF6CC');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__categories AS SELECT id, nom, description, etat FROM categories');
        $this->addSql('DROP TABLE categories');
        $this->addSql('CREATE TABLE categories (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, nom VARCHAR(255) NOT NULL, etat BOOLEAN NOT NULL, description VARCHAR(255) DEFAULT NULL COLLATE BINARY)');
        $this->addSql('INSERT INTO categories (id, nom, description, etat) SELECT id, nom, description, etat FROM __temp__categories');
        $this->addSql('DROP TABLE __temp__categories');
        $this->addSql('DROP INDEX IDX_4B95703CA21214B7');
        $this->addSql('DROP INDEX IDX_4B95703C10007789');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__commentaires AS SELECT id, user_id, articles_id, etat, message, date FROM commentaires');
        $this->addSql('DROP TABLE commentaires');
        $this->addSql('CREATE TABLE commentaires (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, user_id INTEGER DEFAULT NULL, articles_id INTEGER DEFAULT NULL, etat VARCHAR(255) NOT NULL, date DATETIME NOT NULL, message VARCHAR(255) NOT NULL COLLATE BINARY)');
        $this->addSql('INSERT INTO commentaires (id, user_id, articles_id, etat, message, date) SELECT id, user_id, articles_id, etat, message, date FROM __temp__commentaires');
        $this->addSql('DROP TABLE __temp__commentaires');
        $this->addSql('CREATE INDEX IDX_D9BEC0C4A76ED395 ON commentaires (user_id)');
        $this->addSql('CREATE INDEX IDX_D9BEC0C41EBAF6CC ON commentaires (articles_id)');
        $this->addSql('CREATE TEMPORARY TABLE __temp__fichiers AS SELECT id, image, tag, degrade, enligne FROM fichiers');
        $this->addSql('DROP TABLE fichiers');
        $this->addSql('CREATE TABLE fichiers (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, image VARCHAR(255) DEFAULT NULL, degrade BOOLEAN NOT NULL, enligne BOOLEAN NOT NULL, tag BOOLEAN NOT NULL)');
        $this->addSql('INSERT INTO fichiers (id, image, tag, degrade, enligne) SELECT id, image, tag, degrade, enligne FROM __temp__fichiers');
        $this->addSql('DROP TABLE __temp__fichiers');
        $this->addSql('CREATE TEMPORARY TABLE __temp__liens_externes AS SELECT id, site, url, prix, observation FROM liens_externes');
        $this->addSql('DROP TABLE liens_externes');
        $this->addSql('CREATE TABLE liens_externes (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, site VARCHAR(255) DEFAULT NULL, url VARCHAR(255) DEFAULT NULL, prix INTEGER DEFAULT NULL, observation VARCHAR(255) DEFAULT NULL COLLATE BINARY)');
        $this->addSql('INSERT INTO liens_externes (id, site, url, prix, observation) SELECT id, site, url, prix, observation FROM __temp__liens_externes');
        $this->addSql('DROP TABLE __temp__liens_externes');
        $this->addSql('CREATE TEMPORARY TABLE __temp__liens_internes AS SELECT id, observation FROM liens_internes');
        $this->addSql('DROP TABLE liens_internes');
        $this->addSql('CREATE TABLE liens_internes (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, observation VARCHAR(255) DEFAULT NULL COLLATE BINARY)');
        $this->addSql('INSERT INTO liens_internes (id, observation) SELECT id, observation FROM __temp__liens_internes');
        $this->addSql('DROP TABLE __temp__liens_internes');
        $this->addSql('DROP INDEX IDX_418836DA10E8B56');
        $this->addSql('DROP INDEX IDX_418836DBD0E3E18');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__promotions AS SELECT id, date_start, date_end, etat, nom, description, type, valeur FROM promotions');
        $this->addSql('DROP TABLE promotions');
        $this->addSql('CREATE TABLE promotions (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, date_start DATETIME NOT NULL, date_end DATETIME DEFAULT NULL, etat BOOLEAN NOT NULL, nom VARCHAR(255) NOT NULL, type VARCHAR(255) NOT NULL, valeur INTEGER NOT NULL, description VARCHAR(255) DEFAULT NULL COLLATE BINARY)');
        $this->addSql('INSERT INTO promotions (id, date_start, date_end, etat, nom, description, type, valeur) SELECT id, date_start, date_end, etat, nom, description, type, valeur FROM __temp__promotions');
        $this->addSql('DROP TABLE __temp__promotions');
        $this->addSql('DROP INDEX IDX_5F50D568A76ED395');
        $this->addSql('DROP INDEX IDX_5F50D5681EBAF6CC');
