 ...
 */
final class Version20210509131124 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE promotion (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, date_start DATETIME NOT NULL, date_end DATETIME DEFAULT NULL, etat BOOLEAN NOT NULL, nom VARCHAR(255) NOT NULL, description CLOB DEFAULT NULL, type VARCHAR(255) NOT NULL, valeur INTEGER NOT NULL)');
        $this->addSql('DROP TABLE categorie_promotions');
        $this->addSql('DROP TABLE commande_promotions');
        ...
        $this->addSql('CREATE TABLE article (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, promotion_id INTEGER DEFAULT NULL, titre VARCHAR(255) NOT NULL COLLATE BINARY, description CLOB DEFAULT NULL COLLATE BINARY, multimedia VARCHAR(255) DEFAULT NULL COLLATE BINARY, etat VARCHAR(255) NOT NULL COLLATE BINARY, quantite INTEGER NOT NULL, frais_envoi INTEGER NOT NULL, prix INTEGER DEFAULT NULL, CONSTRAINT FK_23A0E66139DF194 FOREIGN KEY (promotion_id) REFERENCES promotion (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO article (id, promotion_id, titre, description, multimedia, etat, quantite, frais_envoi, prix) SELECT id, promotions_id, titre, description, multimedia, etat, quantite, frais_envoi, prix FROM __temp__article');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE commande_promotions (commande_id INTEGER NOT NULL, promotions_id INTEGER NOT NULL, PRIMARY KEY(commande_id, promotions_id))');
        $this->addSql('CREATE INDEX IDX_72D91CD282EA2E54 ON commande_promotions (commande_id)');
        $this->addSql('CREATE INDEX IDX_72D91CD210007789 ON commande_promotions (promotions_id)');
        $this->addSql('CREATE TABLE promotions (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, date_start DATETIME NOT NULL, date_end DATETIME DEFAULT NULL, etat BOOLEAN NOT NULL, nom VARCHAR(255) NOT NULL COLLATE BINARY, type VARCHAR(255) NOT NULL COLLATE BINARY, valeur INTEGER NOT NULL, description CLOB DEFAULT NULL COLLATE BINARY)');
        ...
        $this->addSql('DROP TABLE article');
        $this->addSql('CREATE TABLE article (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, promotions_id INTEGER DEFAULT NULL, titre VARCHAR(255) NOT NULL, description CLOB DEFAULT NULL, multimedia VARCHAR(255) DEFAULT NULL, etat VARCHAR(255) NOT NULL, quantite INTEGER NOT NULL, frais_envoi INTEGER NOT NULL, prix INTEGER DEFAULT NULL, CONSTRAINT FK_23A0E66139DF194 FOREIGN KEY (promotions_id) REFERENCES promotion (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO article (id, promotions_id, titre, description, multimedia, etat, quantite, frais_envoi, prix) SELECT id, promotion_id, titre, description, multimedia, etat, quantite, frais_envoi, prix FROM __temp__article');
        $this->addSql('DROP TABLE __temp__article');
