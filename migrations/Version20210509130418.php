 ...
 */
final class Version20210509130418 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('DROP TABLE commandes_promotion');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE commandes_promotion (commandes_id INTEGER NOT NULL, promotion_id INTEGER NOT NULL, PRIMARY KEY(commandes_id, promotion_id))');
        $this->addSql('CREATE INDEX IDX_DD9AD35410007789 ON commandes_promotion (promotion_id)');
        $this->addSql('CREATE INDEX IDX_DD9AD3548BF5C2E6 ON commandes_promotion (commandes_id)');
