 ...
 */
final class Version20210509130924 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE liens_interne (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, observation CLOB DEFAULT NULL)');
        ...
        $this->addSql('CREATE INDEX IDX_DEE08321A10E8B56 ON materiel_liens_interne (materiel_id)');
        $this->addSql('CREATE INDEX IDX_DEE08321BFBAFD8B ON materiel_liens_interne (liens_interne_id)');
        $this->addSql('DROP TABLE liens_interne');
        ...
        $this->addSql('DROP INDEX IDX_CCCF08D37A5C26FE');
        $this->addSql('DROP INDEX IDX_CCCF08D3A10E8B56');
        ...
        $this->addSql('CREATE TABLE materiel_liens_externe (materiel_id INTEGER NOT NULL, liens_externe_id INTEGER NOT NULL, PRIMARY KEY(materiel_id, liens_externe_id), CONSTRAINT FK_CCCF08D3A10E8B56 FOREIGN KEY (materiel_id) REFERENCES materiel (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_CCCF08D37A5C26FE FOREIGN KEY (liens_externe_id) REFERENCES liens_externe (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE)');
        ...
        $this->addSql('CREATE INDEX IDX_CCCF08D37A5C26FE ON materiel_liens_externe (liens_externe_id)');
        $this->addSql('CREATE INDEX IDX_CCCF08D3A10E8B56 ON materiel_liens_externe (materiel_id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE liens_interne (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, observation CLOB DEFAULT NULL COLLATE BINARY)');
        $this->addSql('CREATE TABLE materiel_liens_interne (materiel_id INTEGER NOT NULL, liens_interne_id INTEGER NOT NULL, PRIMARY KEY(materiel_id, liens_interne_id))');
