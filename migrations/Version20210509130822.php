 ...
 */
final class Version20210509130822 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE liens_externe (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, site VARCHAR(255) DEFAULT NULL, url VARCHAR(255) DEFAULT NULL, prix INTEGER DEFAULT NULL, observation CLOB DEFAULT NULL)');
        ...
        $this->addSql('DROP TABLE liens_externe');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE liens_externe (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, site VARCHAR(255) DEFAULT NULL COLLATE BINARY, url VARCHAR(255) DEFAULT NULL COLLATE BINARY, prix INTEGER DEFAULT NULL, observation CLOB DEFAULT NULL COLLATE BINARY)');
        $this->addSql('CREATE TABLE materiel_liens_externe (materiel_id INTEGER NOT NULL, liens_externe_id INTEGER NOT NULL, PRIMARY KEY(materiel_id, liens_externe_id))');
