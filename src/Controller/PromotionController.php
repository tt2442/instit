<?php
//******no_regenerate*****
namespace  App\Controller ;use App\Entity\Promotion;
...
'form' => $form->createView(),
    ...
    /**
    * @Route("/{id}/copy", name="promotion_copy", methods={"GET","POST"})
    */
public function copy(Request $request, Promotion $promotionc): Response
{
$promotion = clone $promotionc;
