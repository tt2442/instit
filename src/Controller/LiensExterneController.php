<?php
//******no_regenerate*****
namespace  App\Controller ;use App\Entity\LiensExterne;
 ...
 */class LiensExterneController extends AbstractController
{
    ...
    */
    ...
    'liens_externes' => $liensExterneRepository->findAll(),
    ]);
    }
...
{
$liensExterne = clone $liensExternec;

$em = $this->getDoctrine()->getManager();
$em->persist($liensExterne);
$em->flush();
return $this->redirectToRoute('liensExterne_index');
