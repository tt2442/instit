<?php
namespace  App\Controller ;use App\Entity\Commentaires;
...
'form' => $form->createView(),
    ...
    /**
    * @Route("/{id}/copy", name="commentaires_copy", methods={"GET","POST"})
    */
public function copy(Request $request, Commentaires $commentairec): Response
{
$copier = new DeepCopy();
