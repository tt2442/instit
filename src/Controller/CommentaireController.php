<?php
//******no_regenerate*****
namespace  App\Controller ;use App\Entity\Commentaire;
...
'form' => $form->createView(),
    ...
    /**
    * @Route("/{id}/copy", name="commentaire_copy", methods={"GET","POST"})
    */
public function copy(Request $request, Commentaire $commentairec): Response
{
$commentaire = clone $commentairec;

$em = $this->getDoctrine()->getManager();
$em->persist($commentaire);
$em->flush();
return $this->redirectToRoute('commentaire_index');
//$commentaire = $copier->copy($commentairec);
//$form = $this->createForm(CommentaireType::class, $commentaire);
//$form->handleRequest($request);
